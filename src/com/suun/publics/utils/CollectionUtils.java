...
public class CollectionUtils {
	...
	public static List<String> arrayAsList(String[] strings) throws Exception {
	...
	public static List<String> stringAsList(String string, String separator) throws Exception {
