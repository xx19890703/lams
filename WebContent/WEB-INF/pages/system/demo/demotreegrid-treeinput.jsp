    ...
    <script>
     $("#SuunWinForm").validate({
    	 rules: { 
    		 mid: { 
    			required: true, 
    			remote: {url:'${ctx}/system/demo/demotreegrid!treeValidateOid',
    				     type:'post',
			...
			mname:{
				required:true, 
    			remote: {url:'${ctx}/system/demo/demotreegrid!treeValidateName',
				     type:'post',
				     data:{oldname:'${demomain.mname}',id:'${suunplatformTreePid}'}
			    }
			}             	
		},
		messages: {
...
<table>
   <tr>
        ...
        <td width="180" >
                <input type="hidden" name="pmid" value="${suunplatformTreePid}"/> 
