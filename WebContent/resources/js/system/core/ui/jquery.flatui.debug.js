    ...
    $.fn.extend({
		...
		dataSelectCss:function(ctx){
			this.each(function(){
				...
				$(this).wrap('<span style="background-image:url('+ctx+'/dataa.png);'+
							 ...
							 'onclick="'+$(this).attr("onclick").replace(new RegExp('this','i'),"this.firstChild")+'"></span>');
